...
(function () {
    ...
    function showStyledAlert(message) {
        const modal = ensureModal();
        const title = modal.querySelector("[data-asada-modal-title]");
        const messageRoot = modal.querySelector("[data-asada-modal-message]");
        const list = modal.querySelector("[data-asada-modal-list]");
        const confirmButton = modal.querySelector("[data-asada-confirm]");
        const closeButton = modal.querySelector("[data-asada-close]");
        const newButton = modal.querySelector("[data-asada-new]");
        ...
        messageRoot.textContent = String(message || "");
        list.innerHTML = "";
        list.hidden = true;
        confirmButton.hidden = true;
        newButton.hidden = true;
        closeButton.textContent = "Aceptar";
        modal.dataset.asadaModalMode = "notice";
        modal.dataset.asadaAfterClose = "";
        modal.classList.remove("hidden");
        document.body.classList.add("modal-open");
        closeButton.focus();
    ...
    function installStyledAlert() {
        if (window.__asadaStyledAlertInstalled) {
            return;
        }
        ...
        window.__asadaStyledAlertInstalled = true;
    }
