    ...
    function installApiGuard() {
        ...
        const guardedCallApi = async function (action, values) {
            ...
            try {
                ...
                // Cloro/Aforos muestran la confirmación desde cloro_aforo.js
                // después de que Apps Script confirme también el PDF en Drive.
                if (
                    ["saveRecord", "saveAccident", "saveFactibilidad"].includes(action) &&
