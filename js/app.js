...
async function saveMaintenanceForm(
    ...
    if (
        ...
        alert(
            "El registro definitivo necesita Internet para llegar a Google Sheets. Sus datos ya quedaron guardados como borrador local; conéctese y vuelva a guardar para enviarlos."
        );
