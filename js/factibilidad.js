(function () {
    ...
    async function factibilidadGeneratePdf(record) {
        ...
        const addFirstPageHeader = () => {
            if (letterhead) {
                doc.addImage(letterhead, "PNG", 16, 8, 178, 32.7);
            } else if (logo) {
            ...
            const titleY = letterhead ? 52 : 39;
            const subtitleY = letterhead ? 59 : 46;
            const recordY = letterhead ? 67 : 54;
            const dateY = letterhead ? 74 : 61;
            const lineY = letterhead ? 82 : 69;
